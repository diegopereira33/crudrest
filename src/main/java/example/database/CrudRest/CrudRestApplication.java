package example.database.CrudRest;
...
public class CrudRestApplication {
	 ...
	 * repository.deleteAll(); LongStream.range(1, 11).mapToObj(i -> { Contact c =
	 * new Contact(); c.setName("Contact " + i); c.setEmail("contact" + i +
	 * "@email.com"); c.setPhone("(111) 111-1111"); return c; }).map(v ->
